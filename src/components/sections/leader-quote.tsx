    ...
    <Section spacing="md" tone="transparent" className="py-12 sm:py-16">
      <Container size="full" padding="lg">
        <div className="relative overflow-hidden rounded-card bg-brand text-white shadow-brand">
          ...
          <div className="relative flex flex-col items-center gap-8 px-6 py-10 text-center sm:px-10 sm:py-12 lg:flex-row lg:items-center lg:justify-between lg:gap-12 lg:py-14 lg:pl-16 lg:pr-24 lg:text-left">
            <div className="order-2 flex max-w-2xl flex-col gap-5 lg:order-1 lg:flex-1">
              <Quote className="size-8 self-center opacity-80 lg:self-start" />
              <p className="text-base leading-relaxed text-white/95 sm:text-lg lg:text-xl">
              ...
              <div className="flex flex-col gap-0.5 pt-2">
                ...
                <span className="text-sm text-white/75">Founder</span>
              </div>
            </div>

            <div className="relative order-1 shrink-0 lg:order-2">
              <div className="pointer-events-none absolute inset-0 -m-3 rounded-full border border-white/20" />
              <div className="pointer-events-none absolute inset-0 -m-6 rounded-full border border-white/10" />
