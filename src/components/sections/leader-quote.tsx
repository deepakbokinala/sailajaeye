    ...
    <Section spacing="md" tone="transparent" className="py-12 sm:py-16">
      <Container size="full" padding="lg">
        <div className="relative overflow-hidden rounded-card bg-brand text-white shadow-brand">
          ...
          <div className="relative flex flex-col items-center gap-8 px-6 py-10 text-center sm:px-10 sm:py-12 lg:flex-row lg:items-center lg:gap-16 lg:px-16 lg:text-left">
            ...
            <div className="order-2 flex max-w-2xl flex-col gap-5 lg:order-1">
